Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/944b4ae605b6b3a4292d19a6bca5c708"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if(0.0)
				{
					emissionColor0 = hueShift(emissionColor0, frac(1.0 + 3.0 * _Time.x), 0.0, 1.0);
