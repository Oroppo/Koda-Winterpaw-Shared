Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/97fa7f1cc86383b42be6f6183a52f25d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(1,4,0,0), 1.0, float4(0,3,0,0), 1.0, _EmissionAL0Enabled);
				...
				if (_ScrollingEmission)
				{
					...
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-10,0,0).xyz, 10.0, 20.0, 2.0, 0.0, pos);
					}
				}
				if (0.0)
				{
